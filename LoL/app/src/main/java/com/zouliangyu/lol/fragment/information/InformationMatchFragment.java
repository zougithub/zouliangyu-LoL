 ...
 */
public class InformationMatchFragment extends BaseFragment{
...
//            R.mipmap.hongxiang3, R.mipmap.anfeng};
    ...
    public void initData() {
        ...
        GsonRequest<InformationNewestBean> gsonRequest = new GsonRequest<>(Request.Method.GET,
                "http://lol.zhangyoubao.com/apis/rest/ItemsService/lists?cattype=news&catid=10006&page=1&i_=EAC1B788-00BC-454A-A9B9-460852CFC011&t_=1438754522&p_=15911&v_=40050303&d_=ios&osv_=8.3&version=0&a_=lol",
    ...
    private void addBanner(BannerBean bannerBean) {
        ...
        String e = bannerBean.getData().get(4).getPic_ad_url();


        urls = new String[]{a, b, c, d, e};
